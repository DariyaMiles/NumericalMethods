% A difference method for solving a boundary value problem for a second-order ODE
...
disp('Running method for main grid');
[m, k] = SweepMethodCoef(N, h, p, q, f, p1, d1);

% Back run of running method
y = zeros(1, N + 1);
...
disp('  Actual error in the grid nodes:');
for i = 1 : 1 : (N + 1)
...
disp('Running method for shifted grid');
% adding two nodes
